...
class Net(nn.Module):
    def __init__(self):
        ...
        # 01_Classification.py 예제보다 레이어를 한층 추가 하고 노드수를 늘려 보자.
        self.linear = nn.Linear(2, 10) # Wx+b nn.Linear(input, output화
        ...
        nn.init.uniform_(self.linear2.weight, -1, 1) # weight를 -1.0~1.0로 uniform normalize로 초기화
        nn.init.zeros_(self.linear2.bias) # bias를 0으로 초기화
